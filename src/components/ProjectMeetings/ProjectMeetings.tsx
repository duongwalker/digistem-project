  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center min-h-96">
        <div className="bg-[#B82375] absolute w-3/4 max-w-7xl flex text-white rounded-lg">
          ...
          <div className="ml-20 mt-7 text-lg">
            <div className="date flex">
              ...
              <div className="ml-4 mt-2">08.10.2024 - 09.10.2024</div>
            </div>
      ...
      <div className="flex justify-center items-center mt-6">
        <div className="bg-[#EE8332] right-0 w-3/4 max-w-7xl flex text-white rounded-lg">
          <div className="ml-20 mt-7 text-lg">
            <div className="date flex">
              <img src={calendar}></img>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-4xl">
            <div className="my-4">
              ...
              <span>
                4th meeting – Dissemination, Quality and Training (Madrid, Spain)
              </span>
              <br></br>
            </div>
            ...
            <div className="my-4">
              ...
              <span>
                3rd meeting – Implementation of the learning, teaching and
                training (Tampere, Finland)
              </span>
              <br></br>
            </div>
            ...
            <div className="my-4">
              ...
              <span>
                2nd meeting – Research and quality meeting (Madrid, Spain)
              </span>
              <br></br>
            </div>
            ...
            <div className="my-4">
              ...
              <span>
                1st meeting – Kick off and Quality meeting (online meeting)
              </span>
              <br></br>
            </div>
          </div>
