...
export function NavBar() {
  ...
  return (
    <div className="navbar w-full flex items-center justify-between bg-transparent absolute px-7% ">
      ...
      <ul className="flex-1 list-none text-right font-helvetica-black ">
        ...
        <li className='inline-block m-2 cursor-pointer relative font-helvetica font-sans '>
          <a href='http://vps218.cesvima.upm.es/moodle/' target='_blank' rel='noopener noreferrer' className='text-xl block px-3 text-center bg-white rounded-full min-w-28 text-[#EF983E] hover:text-white hover:bg-[#9F005D]'>Moodle</a>
        </li>
      </ul>
    </div>
