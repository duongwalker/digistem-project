          ...
          <div className="member">
            ...
            <div className="profile">
              ...
              <div className="profile-text">
                ...
                <ul>
                  ...
                  <li>
                    She has written and contributed to an extensive range of
                    conferences, scientific papers and publications, developed
                    e.g. digital study materials for mathematics studies,
                    lecture notes, web-based learning materials and videos for
                    teaching.
                  </li>
                </ul>
              </div>
            ...
            <div className="profile">
              ...
              <div className="profile-text">
                ...
                <ul>
                  <li>
                    TAMK's Head of Degree Programme in ICT Engineering
                    Department
                  </li>
                  <li>
                    Over 20 year experience of ICT and engineering mathematics'
                    teaching
                  </li>
                  <li>
                    The research focus is on e.g. digital learning, data and
                    learning analytics, self-regulated learning and active
                    learning.
                  </li>
                  <li>
                    Versatile international experience and strong expertise
                    about national and international educational projects:
                    <ul>
                  ...
                  <li>
                    Her PhD concentrated on Utilising Educational Technology and
